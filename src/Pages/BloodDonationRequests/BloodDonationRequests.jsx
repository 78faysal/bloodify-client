...
const BloodDonationRequests = () => {
  ...
  return (
    <div className="pt-24 bg-gray-100 min-h-screen">
      ...
      <p className="text-center mb-10">Let us change the world with a simple act of kindness. Your one donation can save a whole life.</p>
        ...
        {pendingRequests?.map((request) => (
          <div key={request?._id} className="card bg-base-100 hover:shadow-xl">
            <div className="card-body p-5">
              <h2 className="card-title">{request?.requester_name} {request?.requester_email === user?.email && <div className="badge badge-secondary">Your Request</div>}</h2>
              <p>
